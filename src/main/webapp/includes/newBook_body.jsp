<div class = "container">
    ...
    <div class="container col-8 bgColor rounded">
            ...
            <ul class="nav nav-tabs pt-4" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link text-dark" id="store-tab"
                                      ...
                                      <select name="genreId"
                                          ...
                                          <option value="">--Please choose an option--</option>
                                           <c:forEach items="${genres.keySet()}" var="genre">
                                              <c:set var="idAsString">${genres[genre].id}</c:set>
                                              <option value="${genres[genre].id}"
                                                  <c:if test="${idAsString==param.genreId}">
                                                      selected="selected"
                                                  </c:if>
                                              >${genres[genre].genre[language]}

                                              </option>
                                           </c:forEach>
                                      </select>
                                      ${genres[genre].id} ${param.genreId}
                            ...
                            <div class="formTwoRow">
                                ...
                                <input type = "file"
                                       ...
                                       accept=".jpeg,.gif,.png,.svg, .jpg"
                                        value="${not empty param.cover? param.cover: ''}"/>
                        ...
                        <div class="tab-pane fade" id="store" role="tabpanel" aria-labelledby="store-tab">
                                ...
                                <div>
                                    ...
                                    >
                                         <c:forEach begin="1" end="${bookStorage['case']}" varStatus="loop">
                                            <c:set var="idAsString">${loop.count}</c:set>
                                            <option value=${loop.count}
                                            <c:if test="${idAsString==param.caseNum}">
                                                selected
                                            </c:if>
                                            >${loop.count}</option>
                                         </c:forEach>
                                ...
                                <div>
                                    <select name="shelf"
                                         ...
                                         <c:forEach begin="1" end="${bookStorage['shelf']}" varStatus="loop">
                                            <c:set var="idAsString">${loop.count}</c:set>
                                            <option value=${loop.count}
                                                <c:if test="${idAsString==param.shelf}">
                                                    selected
                                                </c:if>
                                            >${loop.count}</option>
                                         </c:forEach>
                                ...
                                <div>
                                    <select name="cell"
                                         ...
                                         <c:forEach begin="1" end="${bookStorage['cell']}" varStatus="loop">
                                            <c:set var="idAsString">${loop.count}</c:set>
                                            <option value=${loop.count}
                                                <c:if test="${idAsString==param.cell}">
                                                    selected
                                                </c:if>
                                            >${loop.count}</option>
                                         </c:forEach>
                            ...
                            <div class = "footerCenterMT1 ">
                                ...
                                <input type="submit" class="btn btn-primary m-auto"
                                       id="saveModalButton"
                                       onClick="submitForms();"
                                       value=<fmt:message key="bookManager.label.saveButton"/>
                                >
                            </div>
